...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "What is the Muturu Cattle Network Initiative?",
      answer:
        "The Muturu Cattle Network Initiative (MCNI) is a dedicated organization focused on the conservation, research, and promotion of Muturu cattle, an indigenous West African breed. We work with researchers, farmers, and communities to preserve this valuable genetic resource and improve livestock management practices.",
    },
    {
    ...
    {
      question: "How can I become a member of MCNI?",
      answer:
    ...
    {
      question: "How does MCNI work with local farmers?",
      answer:
    ...
    {
      question: "What events does MCNI organize?",
      answer:
        "MCNI organizes annual conferences, workshops, training sessions, field days, and community outreach programs. These events bring together researchers, farmers, policymakers, and stakeholders to share knowledge and promote Muturu cattle conservation.",
    },
    {
      question: "How can I access MCNI research publications?",
      answer:
    ...
    {
      question: "Does MCNI provide training opportunities?",
      answer:
    ...
    {
      question: "How can I contact MCNI for collaboration?",
      answer:
